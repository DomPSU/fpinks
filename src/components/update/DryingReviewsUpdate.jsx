...
class DryingReviewsUpdate extends Component {
  constructor(props) {
    super(props);
        ...
        if (id === 'userID' || id === 'writingSampleID') {
          this.setState({ disableForm: true }, () => {
            this.getDryingReview(
              `/drying-reviews/admin/?DryingReviews.user_id=${userID}&DryingReviews.writing_sample_id=${writingSampleID}`,
            );
          });
        }
      },
  ...
  handleSubmit(e) {
    ...
    API.instance
      .put(
        `/drying-reviews/edit/?user_id=${userID}&writing_sample_id=${writingSampleID}`,
        {
          userID,
          writingSampleID,
          approved,
  ...
  render() {
    ...
    return (
      <div className="container text-center">
        <h1 className="p-5">Update a Drying Review</h1>
        <form>
          <div className="row">
...
export default DryingReviewsUpdate;
