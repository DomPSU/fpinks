...
class TransparencyReviewsUpdate extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    if (getURL.indexOf('?') !== -1) {
      this.getTransparencyReview(getURL);
    }
  }

  getTransparencyReview(url) {
    const config = {
      headers: {
  ...
  handleSubmit(e) {
    ...
    API.instance
      .put(
        `/transparency-reviews/edit/?user_id=${userID}&writing_sample_id=${writingSampleID}`,
        {
          userID,
          writingSampleID,
          approved,
  ...
  render() {
    ...
    return (
      <div className="container text-center">
        <h1 className="p-5">Update a Transparency Review</h1>
        <form>
          <div className="row">
...
export default TransparencyReviewsUpdate;
