...
VALUES ('dominicfpinks@gmail.com', 'Dom', 'replace-with-actual-sub-when seeding', 'accounts.google.com', 'admin', 1, NOW(), NOW());
...
-- SheenReviews Parker Quink Blue Noodler's Ink Konrad Flex 
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Parker Quink Blue Noodler's Ink Konrad M 
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Parker Quink Blue Pilot Metropolitan B 
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviewsParker Quink Blue Pilot Metropolitan F 
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Parker Quink Blue Pilot Metropolitan M
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad Flex
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad M
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan B
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan F 
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
-- SheenReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan M 
INSERT INTO SheenReviews (writing_sample_id, user_id, color_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        (SELECT color_id FROM Colors WHERE name='none'),
...
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/iroshizuku_momiji_pilot_metropolitan_m_clairefontaine.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'none', 1, NOW(), NOW());
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
...
-- FeatheringReviews Parker Quink Blue Noodler's Ink Konrad Flex 
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'heavy', 1, NOW(), NOW());
...
-- FeatheringReviews Parker Quink Blue Noodler's Ink Konrad M 
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light', 1, NOW(), NOW());
...
-- FeatheringReviews Parker Quink Blue Pilot Metropolitan B 
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'none', 1, NOW(), NOW());
...
-- FeatheringReviews Parker Quink Blue Pilot Metropolitan F 
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'none', 1, NOW(), NOW());
...
-- FeatheringReviews Parker Quink Blue Pilot Metropolitan M
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'none', 1, NOW(), NOW());
...
-- FeatheringReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad Flex
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'heavy', 1, NOW(), NOW());
...
-- FeatheringReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad M
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light', 1, NOW(), NOW());
...
-- FeatheringReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan B
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light', 1, NOW(), NOW());
...
-- FeatheringReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan F 
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'none', 1, NOW(), NOW());
...
-- FeatheringReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan M 
INSERT INTO FeatheringReviews (writing_sample_id, user_id, amount, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light', 1, NOW(), NOW());
...
-- WaterReviews Parker Quink Blue Noodler's Ink Konrad Flex 
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
...
-- WaterReviews Parker Quink Blue Noodler's Ink Konrad M 
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Parker Quink Blue Pilot Metropolitan B 
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '100% (no smear)', 1, NOW(), NOW());
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_b_amazon_56_gsm.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Parker Quink Blue Pilot Metropolitan F 
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '100% (no smear)', 1, NOW(), NOW());
...
-- WaterReviews Parker Quink Blue Pilot Metropolitan M
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad Flex
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad M
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan B
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan F 
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- WaterReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan M 
INSERT INTO WaterReviews (writing_sample_id, user_id, waterproofness, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'fully legible', 1, NOW(), NOW());
...
-- DryingReviews Parker Quink Blue Noodler's Ink Konrad Flex 
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '10s', 1, NOW(), NOW());
...
-- DryingReviews Parker Quink Blue Noodler's Ink Konrad M 
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Parker Quink Blue Pilot Metropolitan B 
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Parker Quink Blue Pilot Metropolitan F 
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Parker Quink Blue Pilot Metropolitan M
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad Flex
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '4s', 1, NOW(), NOW());
...
-- DryingReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad M
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan B
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan F 
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- DryingReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan M 
INSERT INTO DryingReviews (writing_sample_id, user_id, drying_time, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        '1s', 1, NOW(), NOW());
...
-- TransparencyReviews Parker Quink Blue Noodler's Ink Konrad Flex 
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'heavy bleed-through', 1, NOW(), NOW());
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_flex_amazon_56_gsm.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'heavy bleed-through', 1, NOW(), NOW());
...
-- TransparencyReviews Parker Quink Blue Noodler's Ink Konrad M 
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
...
-- TransparencyReviews Parker Quink Blue Pilot Metropolitan B 
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light ghosting', 1, NOW(), NOW());
...
-- TransparencyReviews Parker Quink Blue Pilot Metropolitan F 
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light ghosting', 1, NOW(), NOW());
...
-- TransparencyReviews Parker Quink Blue Pilot Metropolitan M
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/parker_quink_blue_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light bleed-through', 1, NOW(), NOW());
...
-- TransparencyReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad Flex
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_flex_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'heavy bleed-through', 1, NOW(), NOW());
...
-- TransparencyReviews Noodler's Ink Air-Corp Blue-Black Noodler's Ink Konrad M
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_noodlers_ink_konrad_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light bleed-through', 1, NOW(), NOW());
...
-- TransparencyReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan B
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_b_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light ghosting', 1, NOW(), NOW());
...
-- TransparencyReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan F 
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_f_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'light ghosting', 1, NOW(), NOW());
...
-- TransparencyReviews Noodler's Ink Air-Corp Blue-Black Pilot Metropolitan M 
INSERT INTO TransparencyReviews (writing_sample_id, user_id, transparency, approved, created_at, updated_at)
VALUES ((SELECT writing_sample_id FROM WritingSamples WHERE original_aws_key = 'original/noodlers_ink_air-corp_blue-black_pilot_metropolitan_m_amazon_20lb_printer.jpg'),
        (SELECT user_id From Users WHERE email='dominicfpinks@gmail.com'),
        'heavy ghosting', 1, NOW(), NOW());
